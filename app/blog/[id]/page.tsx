          ...
          >
            ...
            <div className="absolute inset-0">
              <div className="container mx-auto px-4 h-full">
                <div className="max-w-4xl mx-auto h-full flex flex-col justify-end p-4 sm:p-6 md:p-8">
                  ...
                  <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-xs sm:text-sm text-gray-300 mb-3 sm:mb-4">
                    <span className="flex items-center gap-1 sm:gap-2 bg-black/30 backdrop-blur-sm px-2 sm:px-3 py-1 rounded-full border border-blue-500/50">
                  ...
                  <div className="flex items-center justify-between gap-3 sm:gap-4">
                    <div className="flex flex-wrap gap-2 flex-1">
                      {blog.tags?.map((tag, index) => (
                        <span
                          key={index}
                          className="bg-blue-500/20 backdrop-blur-sm text-blue-400 text-xs px-2 sm:px-3 py-1 rounded-full border border-blue-500/50"
                        >
                          {tag}
                        </span>
                      ))}
                    ...
                    <div className="flex items-center shrink-0 gap-1 sm:gap-2">
                      <motion.button
                        ...
                        className="bg-black/30 backdrop-blur-sm p-1.5 sm:p-2 rounded-full border border-gray-800/50 hover:border-blue-500/30 transition-colors"
                      >
                      ...
                      >
                        {isCopied ? (
                          ...
                          <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
